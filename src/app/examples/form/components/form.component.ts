    ...
    if (this.form.valid) {
      ...
      this.snackBar.open(
        this.form.value.requestGift
          ? this.translate.instant('zerofee-app.examples.form.text4')
          : this.translate.instant('zerofee-app.examples.form.text5'),
        this.translate.instant('zerofee-app.examples.form.text6'),
        {
          duration: 1000
        }
      );
