...
export class ExamplesComponent implements OnInit, OnDestroy {
  ...
  examples = [
    { link: 'todos', label: 'zerofee-app.examples.menu.todos' },
    { link: 'stock-market', label: 'zerofee-app.examples.menu.stocks' },
    { link: 'theming', label: 'zerofee-app.examples.menu.theming' },
    { link: 'crud', label: 'zerofee-app.examples.menu.crud' },
    { link: 'form', label: 'zerofee-app.examples.menu.form' },
    { link: 'authenticated', label: 'zerofee-app.examples.menu.auth', auth: true }
  ];
