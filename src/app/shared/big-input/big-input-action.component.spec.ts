...
describe('BigInputActionComponent', () => {
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<zerofee-app-big-input-action [disabled]="true"></zerofee-app-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<zerofee-app-big-input-action fontSet="fas" fontIcon="fa-trash"></zerofee-app-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<zerofee-app-big-input-action label="delete"></zerofee-app-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<zerofee-app-big-input-action (action)="actionHandler()"></zerofee-app-big-input-action>`;
    fixture = createHostComponent(template);
